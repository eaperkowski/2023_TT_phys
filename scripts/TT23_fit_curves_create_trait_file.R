...
licor.data.pre <- read.csv("../data/TT23_licor_merged_pre_closure.csv") %>%
...
spp.meta <- read.csv("../tag_metadata/TT_tag_metadata.csv") %>%
...
spp.meta.closed <- read.csv("../tag_metadata/TT_tag_metadata_canopy_closed.csv") %>%
...
gm.density <- read.csv("../data/raw_data/TT23_GM_density_counts_JM.csv")

# Add keep row delimiter to remove points
licor.data.pre$keep.row <- "yes"
...
# Clean weather data (needed for temp standardization)
temp_data <- read.csv("../data/TT23_NOAA_gchn_uncleaned.csv") %>%
  dplyr::select(date = DATE, tmax_f = TMAX, tmin_f = TMIN) %>%
  mutate(temp_date = lubridate::mdy(date),
         tmax_c = (tmax_f - 32) * (5/9),
         tmin_c = (tmin_f - 32) * (5/9),
         tmean_c = (tmax_c + tmin_c) / 2) %>%
  filter(temp_date > "2023-03-01" & temp_date < "2023-07-01") %>%
  dplyr::select(temp_date, tmax_c, tmin_c, tmean_c)
...
###############################################################################
## Tag: 6578
tri.6578.pre <- fitaci(data = subset(licor.data.pre, id == "6578_b" & keep.row == "yes"),
...
## Tag: 5488
tri.5488.pre <- fitaci(data = subset(licor.data.pre, id == "5488"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
plot(tri.5488.pre)
...
## Tag: 4714
tri.4714.pre <- fitaci(data = subset(licor.data.pre, id == "4714_a" & keep.row == "yes"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4714.pre)
...
## Tag: 902
tri.902.pre <- fitaci(data = subset(licor.data.pre, id == "902" & (A < 1 | A > 16)),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.902.pre)
...
## Tag: 3563
tri.3563.pre <- fitaci(data = subset(licor.data.pre, id == "3563" & (A < 1.5 | A > 13)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.3563.pre)
...
## Tag: 1686
tri.1686.pre <- fitaci(data = subset(licor.data.pre, id == "1686" & (A < 1.25 | A > 15)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.1686.pre)
...
## Tag: 425
# tri.425.pre <- fitaci(data = subset(licor.data.pre, id == "425" & keep.row == "yes"),
#                    varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
#                                     Ci = "Ci", PPFD = "Qin"),
#                    fitTPU = TRUE)
# plot(tri.425.pre)
aci.coefs[7,] <- c(id = "425", spp = "Tri", plot = "3", timepoint = "pre_closure", 
                   Vcmax = NA, Jmax = NA, Rd = NA, TPU = NA)

## Tag: 2416
tri.2416.pre <- fitaci(data = subset(licor.data.pre, id == "2416" & (A < 1.25 | A > 14)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2416.pre)
...
## Tag: 552
tri.552.pre <- fitaci(data = subset(licor.data.pre, id == "552" & keep.row == "yes"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.552.pre)
...
## Tag: 5495
tri.5495.pre <- fitaci(data = subset(licor.data.pre, id == "5495" & keep.row == "yes"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.5495.pre)
...
## Tag: 916
tri.916.pre <- fitaci(data = subset(licor.data.pre, id == "916" & keep.row == "yes"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.916.pre)
...
## Tag: 583
tri.583.pre <- fitaci(data = subset(licor.data.pre, id == "583a_redo" & (A < 2 | A > 11.3)),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
plot(tri.583.pre)
...
## Tag: 5479
tri.5479.pre <- fitaci(data = subset(licor.data.pre, id == "5479a" & (A > 0 & A < 1 | A > 13.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.5479.pre)
...
## Tag: 4934
tri.4934.pre <- fitaci(data = subset(licor.data.pre, id == "4934a_redo" & keep.row == "yes"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4934.pre)
...
## Tag: 6558
tri.6558.pre <- fitaci(data = subset(licor.data.pre, id == "6558" & (A < 1.5 | A > 16)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.6558.pre)
aci.coefs[15,] <- c(id = "6558", spp = "Tri", plot = "3", timepoint = "pre_closure", 
                    t(coef(tri.6558.pre)))
## Tag: 2329
tri.2329.pre <- fitaci(data = subset(licor.data.pre, id == "2329" & (A < 1.5 | A > 12.1)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 250, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2329.pre)
aci.coefs[16,] <- c(id = "2329", spp = "Tri", plot = "3", timepoint = "pre_closure", 
                    t(coef(tri.2329.pre)))

## Tag: 774
tri.774.pre <- fitaci(data = subset(licor.data.pre, id == "774" & (A < 1 | A > 14)),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      citransition = 300, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.774.pre)
aci.coefs[17,] <- c(id = "774", spp = "Tri", plot = "3", timepoint = "pre_closure", 
                    t(coef(tri.774.pre)))

## Tag: 4942
tri.4942.pre <- fitaci(data = subset(licor.data.pre, id == "4942" & (A < 1.5 | A > 15)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4942.pre)
...
## Tag: 4942
tri.1926.pre <- fitaci(data = subset(licor.data.pre, id == "1926"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
plot(tri.1926.pre)
...
###############################################################################
## Tag: 2547
tri.2547.pre <- fitaci(data = subset(licor.data.pre, id == "2547b" & keep.row == "yes"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2547.pre)
...
## Tag: 5115
tri.5115.pre <- fitaci(data = subset(licor.data.pre, id == "5115" & (A < 1 | A > 15)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 300, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.5115.pre)
...
## Tag: 5228
tri.5228.pre <- fitaci(data = subset(licor.data.pre, id == "5228" & (A > 0 & A < 1 | A > 10)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
...
## Tag: 4000
tri.4000.pre <- fitaci(data = subset(licor.data.pre, id == "4000" & (A > 0 & A < 1.5 | A > 18)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4000.pre)
...
## Tag: 3004
tri.3004.pre <- fitaci(data = subset(licor.data.pre, id == "3004" & (A < 1 | A > 15)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 300, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.3004.pre)
...
## Tag: 3077
tri.3077.pre <- fitaci(data = subset(licor.data.pre, id == "3077" & (A > 0 & A < 1 | A > 15)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 250, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.3077.pre)
...
## Tag: 4576
tri.4576.pre <- fitaci(data = subset(licor.data.pre, id == "4576" & (A > 0 & A < 1 | A > 12.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 290, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4576.pre)
aci.coefs[25,] <- c(id = "4576", spp = "Tri", plot = "5", timepoint = "pre_closure", 
                    t(coef(tri.4576.pre)))

## Tag: 482
tri.482.pre <- fitaci(data = subset(licor.data.pre, id == "482" & (A > 0 & A < 1 | A > 12)),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      citransition = 250, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.482.pre)
...
## Tag: 4414
tri.4414.pre <- fitaci(data = subset(licor.data.pre, id == "4414" & (A > 0 & A < 1 | A > 15.7)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4414.pre)
...
## Tag: 4959
tri.4959.pre <- fitaci(data = subset(licor.data.pre, id == "4959" & (A > 0 & A < 1 | A > 14)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 225, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4959.pre)
aci.coefs[28,] <- c(id = "4959", spp = "Tri", plot = "5", timepoint = "pre_closure", 
                    t(coef(tri.4959.pre)))

## Tag: 4990
tri.4990.pre <- fitaci(data = subset(licor.data.pre, id == "4990" & (A > 0 & A < 1.5 | A > 15)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 252, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4990.pre)
aci.coefs[29,] <- c(id = "4990", spp = "Tri", plot = "5", timepoint = "pre_closure", 
                    t(coef(tri.4990.pre)))

## Tag: 4431
tri.4431.pre <- fitaci(data = subset(licor.data.pre, id == "4431" & (A > 0 & A < 2 | A > 11)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4431.pre)
...
## Tag: 5877
tri.5877.pre <- fitaci(data = subset(licor.data.pre, id == "5877" & (A > 0 & A < 1 | A > 14)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 240, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.5877.pre)
aci.coefs[32,] <- c(id = "5877", spp = "Tri", plot = "5", timepoint = "pre_closure", 
                    t(coef(tri.5877.pre)))

## Tag: 2988
tri.2988.pre <- fitaci(data = subset(licor.data.pre, id == "2988" & (A > 0 & A < 2 | A > 14.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 240, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2988.pre)
...
## Tag: 4109
tri.4109.pre <- fitaci(data = subset(licor.data.pre, id == "4109" & (A > 0 & A < 2 | A > 14.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4109.pre)
...
## Tag: 2508
tri.2508.pre <- fitaci(data = subset(licor.data.pre, id == "2508" & (A > 0 & A < 2 | A > 14.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2508.pre)
...
## Tag: 43
tri.43.pre <- fitaci(data = subset(licor.data.pre, id == "43"),
                     varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                      Ci = "Ci", PPFD = "Qin"),
                     Tcorrect = FALSE, fitTPU = TRUE)
plot(tri.43.pre)
...
## Tag: 86
tri.86.pre <- fitaci(data = subset(licor.data.pre, id == "86"),
                     varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                      Ci = "Ci", PPFD = "Qin"),
                     Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.86.pre)
...
## Tag: 5904
tri.5904.pre <- fitaci(data = subset(licor.data.pre, id == "5904"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.5904.pre)
...
## Tag: 7147
tri.7147.pre <- fitaci(data = subset(licor.data.pre, id == "7147"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.7147.pre)
...
## Tag: 1374
tri.1374.pre <- fitaci(data = subset(licor.data.pre, id == "1374" & (A < 4 | A > 14)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.1374.pre)
...
## Tag: 4105
tri.4105.pre <- fitaci(data = subset(licor.data.pre, id == "4105" & (A < 4 | A > 14)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 250, Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4105.pre)
...
## Tag: 4547
tri.4547.pre <- fitaci(data = subset(licor.data.pre, id == "4547" & (A < 4 | A > 16)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4547.pre)
...
## Tag: 5381
tri.5381.pre <- fitaci(data = subset(licor.data.pre, id == "5381" & (A < 4 | A > 16)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.5381.pre)
...
## Tag: 614
tri.614.pre <- fitaci(data = subset(licor.data.pre, id == "614" & (A < 4 | A > 16)),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.614.pre)
...
## Tag: 2912
tri.2912.pre <- fitaci(data = subset(licor.data.pre, id == "2912" & (A < 6 | A > 16)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2912.pre)
...
## Tag: 1795
tri.1795.pre <- fitaci(data = subset(licor.data.pre, id == "1795" & (A < 6 | A > 16)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.1795.pre)
...
## Tag: 2563
tri.2563.pre <- fitaci(data = subset(licor.data.pre, id == "2563" & (A < 4 | A > 16)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2563.pre)
...
## Tag: flag_8
tri.flag_8.pre <- fitaci(data = subset(licor.data.pre, id == "flag_8" & (A < 4 | A > 16)),
                         varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                          Ci = "Ci", PPFD = "Qin"),
                         Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.flag_8.pre)
...
## Tag: 2573
tri.2573.pre <- fitaci(data = subset(licor.data.pre, id == "2573" & (A < 4 | A > 16)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2573.pre)
...
## Tag: flag_3
tri.flag_3.pre <- fitaci(data = subset(licor.data.pre, id == "flag3" & (A < 4 | A > 16)),
                         varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                          Ci = "Ci", PPFD = "Qin"),
                         Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.flag_3.pre)
...
## Tag: 4177
tri.4177.pre <- fitaci(data = subset(licor.data.pre, id == "4177"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4177.pre)
...
## Tag: 1739
tri.1739.pre <- fitaci(data = subset(licor.data.pre, id == "1739"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.1739.pre)
...
###############################################################################
## Tag: 632
tri.632.pre <- fitaci(data = subset(licor.data.pre, id == "632"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.632.pre)
...
## Tag: 1827
tri.1827.pre <- fitaci(data = subset(licor.data.pre, id == "1827"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.1827.pre)
...
## Tag: 1851
tri.1851.pre <- fitaci(data = subset(licor.data.pre, id == "1851" & (A < 4 | A > 15)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.1851.pre)
...
## Tag: 3071
tri.3071.pre <- fitaci(data = subset(licor.data.pre, id == "3071" & (A < 4 | A > 15.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.3071.pre)
...
## Tag: 2927
tri.2927.pre <- fitaci(data = subset(licor.data.pre, id == "2927" & (A < 4 | A > 15.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2927.pre)
...
## Tag: 2996
tri.2996.pre <- fitaci(data = subset(licor.data.pre, id == "2996" & (A < 4 | A > 15.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2996.pre)
...
## Tag: 972
tri.972.pre <- fitaci(data = subset(licor.data.pre, id == "972" & (A < 4 | A > 13.5)),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.972.pre)
...
## Tag: 1647
tri.1647.pre <- fitaci(data = subset(licor.data.pre, id == "1647" & (A < 4 | A > 12)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.1647.pre)
...
## Tag: 1669
tri.1669.pre <- fitaci(data = subset(licor.data.pre, id == "1669" & (A < 4 | A > 15)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.1669.pre)
...
## plot 7 here)
tri.2131.pre <- fitaci(data = subset(licor.data.pre, id == "2131" & is.na(machine) & (A < 6 | A > 14)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2131.pre)
...
## Tag: 2289
tri.2289.pre <- fitaci(data = subset(licor.data.pre, id == "2289" & (A < 4 | A > 16.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2289.pre)
...
## Tag: 2379
tri.2379.pre <- fitaci(data = subset(licor.data.pre, id == "2379" & (A < 4 | A > 16.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2379.pre)
...
## Tag: 2382
tri.2382.pre <- fitaci(data = subset(licor.data.pre, id == "2382" & (A < 4 | A > 12)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2382.pre)
...
## Tag: 1997
tri.1997.pre <- fitaci(data = subset(licor.data.pre, id == "1997" & (A < 4 | A > 14)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.1997.pre)
...
## Tag: 2886
tri.2886.pre <- fitaci(data = subset(licor.data.pre, id == "2886" & (A < 4 | A > 11.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.2886.pre)
...
## Tag: 3043
tri.3043.pre <- fitaci(data = subset(licor.data.pre, id == "3043" & (A < 4 | A > 11.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.3043.pre)
...
## Tag: 3427
tri.3427.pre <- fitaci(data = subset(licor.data.pre, id == "3427" & (A < 3 | A > 10.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.3427.pre)
...
## Tag: 3526
tri.3526.pre <- fitaci(data = subset(licor.data.pre, id == "3526" & (A < 3 | A > 14)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.3526.pre)
...
## Tag: 1975
tri.1975.pre <- fitaci(data = subset(licor.data.pre, id == "1975" & (A < 2 | A > 12)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.1975.pre)
...
## Tag: 4081
tri.4081.pre <- fitaci(data = subset(licor.data.pre, id == "4081" & (A < 3 | A > 14)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.4081.pre)
...
## Tag: 6507
tri.6507.pre <- fitaci(data = subset(licor.data.pre, id == "6507" & (A < 10 | A > 14)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.6507.pre)
...
## Tag: 7574
tri.7574.pre <- fitaci(data = subset(licor.data.pre, id == "7574"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(tri.7574.pre)
...
###############################################################################
## Tag: 3643
mai.3643.pre <- fitaci(data = subset(licor.data.pre, id == "3643"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.3643.pre)
...
## Tag: 141
mai.141.pre <- fitaci(data = subset(licor.data.pre, id == "141"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.141.pre)
...
## Tag: 4250
mai.4250.pre <- fitaci(data = subset(licor.data.pre, id == "4250"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.4250.pre)
...
## Tag: 9412_actual
mai.9412act.pre <- fitaci(data = subset(licor.data.pre, id == "9412_actual"),
                          varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                           Ci = "Ci", PPFD = "Qin"),
                          Tcorrect = FALSE, fitTPU = TRUE)
...
## Tag: 9412
mai.9412.pre <- fitaci(data = subset(licor.data.pre, id == "9412"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.9412.pre)
...
## Tag: 2310
mai.2310.pre <- fitaci(data = subset(licor.data.pre, id == "2310"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.2310.pre)
...
## Tag: 1021
mai.1021.pre <- fitaci(data = subset(licor.data.pre, id == "1021"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.1021.pre)
...
## Tag: 2268
mai.2268.pre <- fitaci(data = subset(licor.data.pre, id == "2268"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.2268.pre)
...
## Tag: 5069
mai.5069.pre <- fitaci(data = subset(licor.data.pre, id == "5069"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.5069.pre)
...
## Tag: 5030
mai.5030.pre <- fitaci(data = subset(licor.data.pre, id == "5030"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.5030.pre)
...
## Tag: 2337
mai.2337.pre <- fitaci(data = subset(licor.data.pre, id == "2337"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.2337.pre)
...
## Tag: 179
mai.179.pre <- fitaci(data = subset(licor.data.pre, id == "179"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.179.pre)
...
## Tag: 511
mai.511.pre <- fitaci(data = subset(licor.data.pre, id == "511"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.511.pre)
...
## Tag: 543
mai.543.pre <- fitaci(data = subset(licor.data.pre, id == "543"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.543.pre)
...
## Tag: 1157
mai.1157.pre <- fitaci(data = subset(licor.data.pre, id == "1157"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.1157.pre)
...
## Tag: 1663
mai.1663.pre <- fitaci(data = subset(licor.data.pre, id == "1663"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.1663.pre)
...
mai.2131.pre <- fitaci(data = subset(licor.data.pre, id == "2131" & machine == "stan"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.2131.pre)
...
## Tag: 3665
mai.3665.pre <- fitaci(data = subset(licor.data.pre, id == "3665"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.3665.pre)
...
###############################################################################
## Tag: 5052
mai.5052.pre <- fitaci(data = subset(licor.data.pre, id == "5052"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.5052.pre)
...
## Tag: 2616
mai.2616.pre <- fitaci(data = subset(licor.data.pre, id == "2616"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.2616.pre)
...
## Tag: 2662
mai.2662.pre <- fitaci(data = subset(licor.data.pre, id == "2662"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.2662.pre)
...
## Tag: 4781
mai.4781.pre <- fitaci(data = subset(licor.data.pre, id == "4781"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.4781.pre)
...
## Tag: 5657
mai.5657.pre <- fitaci(data = subset(licor.data.pre, id == "5657"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.5657.pre)
...
## Tag: 631
mai.631.pre <- fitaci(data = subset(licor.data.pre, id == "631"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.631.pre)
...
## Tag: 3960
mai.3960.pre <- fitaci(data = subset(licor.data.pre, id == "3960"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.3960.pre)
...
## Tag: flag_2
mai.flag_2.pre <- fitaci(data = subset(licor.data.pre, id == "flag 2"),
                         varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                          Ci = "Ci", PPFD = "Qin"),
                         Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.flag_2.pre)
...
## Tag: 1432
mai.1432.pre <- fitaci(data = subset(licor.data.pre, id == "1432"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.1432.pre)
...
## Tag: 1499
mai.1499.pre <- fitaci(data = subset(licor.data.pre, id == "1499"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.1499.pre)
...
## Tag: 3993
mai.3993.pre <- fitaci(data = subset(licor.data.pre, id == "3993"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.3993.pre)
...
###############################################################################
## Tag: 1159
mai.1159.pre <- fitaci(data = subset(licor.data.pre, id == "1159"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.1159.pre)
...
## Tag: 3539
mai.3539.pre <- fitaci(data = subset(licor.data.pre, id == "3539"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.3539.pre)
...
## Tag: 901
mai.901.pre <- fitaci(data = subset(licor.data.pre, id == "901"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.901.pre)
...
## Tag: 1817
mai.1817.pre <- fitaci(data = subset(licor.data.pre, id == "1817"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.1817.pre)
...
## Tag: 6027
mai.6027.pre <- fitaci(data = subset(licor.data.pre, id == "6027"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.6027.pre)
...
## Tag: 1153
mai.1153.pre <- fitaci(data = subset(licor.data.pre, id == "1153"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.1153.pre)
...
## Tag: 6000
mai.6000.pre <- fitaci(data = subset(licor.data.pre, id == "6000"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.6000.pre)
...
## Tag: 6808
mai.6808.pre <- fitaci(data = subset(licor.data.pre, id == "6808"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.6808.pre)
...
## Tag: 545
mai.545.pre <- fitaci(data = subset(licor.data.pre, id == "545"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.545.pre)
...
## Tag: 2546
mai.2546.pre <- fitaci(data = subset(licor.data.pre, id == "2546" & (A < 1 | A > 7.5)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.2546.pre)
...
## Tag: 235
mai.235.pre <- fitaci(data = subset(licor.data.pre, id == "235" & (A < 1.5 | A > 10)),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.235.pre)
...
## Tag: 6100
mai.6100.pre <- fitaci(data = subset(licor.data.pre, id == "6100" & (A <3 | A > 10)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.6100.pre)
...
## Tag: 6685
mai.6685.pre <- fitaci(data = subset(licor.data.pre, id == "6685"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.6685.pre)
...
## Tag: 4883
mai.4883.pre <- fitaci(data = subset(licor.data.pre, id == "4883" & (A < 4 | A > 12)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.4883.pre)
...
## Tag: 4874
mai.4874.pre <- fitaci(data = subset(licor.data.pre, id == "4874"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.4874.pre)
...
## Tag: 42
mai.42.pre <- fitaci(data = subset(licor.data.pre, id == "42"),
                     varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                      Ci = "Ci", PPFD = "Qin"),
                     Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.42.pre)
...
## Tag: 4834
mai.4834.pre <- fitaci(data = subset(licor.data.pre, id == "4834"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.4834.pre)
...
## Tag: 4844
mai.4844.pre <- fitaci(data = subset(licor.data.pre, id == "4844"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.4844.pre)
...
## Tag: 4871
mai.4871.pre <- fitaci(data = subset(licor.data.pre, id == "4871"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.4871.pre)
...
## Tag: 2666
mai.2666.pre <- fitaci(data = subset(licor.data.pre, id == "2666"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.2666.pre)
...
## Tag: 5073
mai.5073.pre <- fitaci(data = subset(licor.data.pre, id == "5073"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.5073.pre)
...
## Tag: 5015
mai.5015.pre <- fitaci(data = subset(licor.data.pre, id == "5015"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.5015.pre)
...
## Tag: 5077
mai.5077.pre <- fitaci(data = subset(licor.data.pre, id == "5077"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.5077.pre)
...
## Tag: 1240
mai.1240.pre <- fitaci(data = subset(licor.data.pre, id == "1240"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.1240.pre)
...
## Tag: 1264
mai.1264.pre <- fitaci(data = subset(licor.data.pre, id == "1264"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.1264.pre)
...
## Tag: 860
mai.860.pre <- fitaci(data = subset(licor.data.pre, id == "860"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.860.pre)
...
## Tag: 682
mai.682.pre <- fitaci(data = subset(licor.data.pre, id == "682"),
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.682.pre)
...
## Tag: 3581
mai.3581.pre <- fitaci(data = subset(licor.data.pre, id == "3581"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.3581.pre)
...
## Tag: 2265
mai.2265.pre <- fitaci(data = subset(licor.data.pre, id == "2265"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.2265.pre)
...
## Tag: 2285
mai.2285.pre <- fitaci(data = subset(licor.data.pre, id == "2285"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.2285.pre)
...
## Tag: 4859
mai.4859.pre <- fitaci(data = subset(licor.data.pre, id == "4859"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.4859.pre)
...
## Tag: 4736
mai.4736.pre <- fitaci(data = subset(licor.data.pre, id == "4736"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
#plot(mai.4736.pre)
...
## Tag: 4865
mai.4865.pre <- fitaci(data = subset(licor.data.pre, id == "4865" & (A > 0 & (A < 2 | A > 10))),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 400, Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.4865.pre)
aci.coefs[131,] <- c(id = "4865", spp = "Mai", plot = "7", timepoint = "pre_closure", 
                     t(coef(mai.4865.pre)))

## Tag: 4676
mai.4676.pre <- fitaci(data = subset(licor.data.pre, id == "4676"),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.4676.pre)
...
## Tag: 4802
mai.4802.pre <- fitaci(data = subset(licor.data.pre, id == "4802" & A > 0 & (A < 1.5 | A > 10)),
                       varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                        Ci = "Ci", PPFD = "Qin"),
                       citransition = 375, Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.4802.pre)
aci.coefs[133,] <- c(id = "4802", spp = "Mai", plot = "7", timepoint = "pre_closure", 
                     t(coef(mai.4802.pre)))

## Tag: 652
mai.652.pre <- fitaci(data = subset(licor.data.pre, id == "625"), ## note error in ID
                      varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                       Ci = "Ci", PPFD = "Qin"),
                      Tcorrect = FALSE, fitTPU = TRUE)
# plot(mai.652.pre)
...
tgrow_pre_prep[139,] <- list("2547", lubridate::date("2023-04-20"))
tgrow_pre_prep[140,] <- list("5479", lubridate::date("2023-04-19"))
tgrow_pre_prep[141,] <- list("583", lubridate::date("2023-04-19"))
tgrow_pre_prep[142,] <- list("652", lubridate::date("2023-05-06"))
tgrow_pre_prep[143,] <- list("flag2_mai", lubridate::date("2023-05-05"))
tgrow_pre_prep[144,] <- list("4934", lubridate::date("2023-04-19"))
tgrow_pre_prep[145,] <- list("6685", lubridate::date("2023-05-06"))
tgrow_pre_prep[146,] <- list("flag3_tri", lubridate::date("2023-04-20"))

tgrow_pre <- tgrow_pre_prep %>%
  merge(temp_data) %>%
  group_by(id, date) %>%
  filter(temp_date >= date - 7 & temp_date < date) %>%
  summarize(tgrow = mean(tmean_c)) %>%
  ungroup(date) %>%
  dplyr:: select(id, tgrow)

###############################################################################
## Snapshot measures at start of each curve
###############################################################################
snapshot.pre <- licor.data.pre %>%
  mutate(id = ifelse(id == "2131" & is.na(machine), "2131_tri", id),
         id = ifelse(id == "2131" & machine == "stan", "2131_mai", id)) %>%
  group_by(id) %>%
  filter(row_number() == 1 & id != "392") %>%
  dplyr::select(id, machine, day, anet = A, ci = Ci, ca = Ca, co2_ref = CO2_r, gsw, Tleaf) %>%
  mutate(ci.ca = ci / ca,
         iwue = anet / gsw) %>%
  filter(id != "4714_b" & id!= "6578" & id != "6578_a" & id != "5479b" & 
           id != "5479c" & id != "583a" & id != "583b" & id != "4934b" & id != "2927_light" &
...
## information 
###############################################################################
aci.coefs.pre <- aci.coefs %>%
  mutate(across(Vcmax:TPU, \(x) as.numeric(x))) %>%
  dplyr::select(id:timepoint, vcmax = Vcmax, jmax = Jmax, rd = Rd, tpu = TPU)

pre.canopy.merged <- snapshot.pre %>%
  full_join(aci.coefs.pre, by = "id") %>%
  full_join(tgrow_pre, by = "id") %>%
  mutate(plot = as.numeric(plot),
         vcmax25 = temp_standardize(estimate = vcmax,
                                    estimate.type = "Vcmax",
                                    standard.to = 25,
                                    tLeaf = Tleaf,
                                    tGrow = tgrow),
  ...
  mutate(jmax.vcmax = jmax25 / vcmax25,
         stomatal_limitation(Anet = as.numeric(anet),
                             ...
                             leaf.temp = Tleaf,
                             temp = "C")[5]) %>%
  filter(id != 425 & id != 4630 & id != 6685 & id != 4736) %>%
  full_join(spp.meta, by = c("id", "plot")) %>%
  mutate(subplot = as.numeric(subplot)) %>%
  filter(!is.na(anet)) %>%
  dplyr::select(id, spp = spp.x, plot, subplot, gm.trt, canopy = timepoint, 
                anet, gsw, l, ci.ca, iwue, vcmax, vcmax25, jmax, jmax25, jmax.vcmax) %>%
  filter(id != "9412") %>%
...
###############################################################################
## Tag: 2662
mai.2662.post <- fitaci(data = subset(licor.data.post, id == "2662" & 
                                        A > 0)[3:96,],
                        varnames = list (ALEAF = "A", Tleaf = "Tleaf", 
                                         Ci = "Ci", PPFD = "Qin"),
                        fitTPU = TRUE, Tcorrect = FALSE, citransition = 600)
summary(mai.2662.post)
# plot(mai.2662.post)
...
## Calculate tGrow
###############################################################################
tgrow_post_prep <- licor.data.post %>%
  mutate(id = ifelse(id == "2131" & is.na(machine), "2131_tri", id),
         id = ifelse(id == "2131" & machine == "stan", "2131_mai", id),
         date = lubridate::date(lubridate::ymd_hms(date))) %>%
  group_by(id, machine) %>%
  filter(row_number() == 1 & id != "392")%>%
...
tgrow_post_prep[90,] <- list("flag2_tri", lubridate::date("2023-06-12"))
tgrow_post_prep[91,] <- list("flag3_tri", lubridate::date("2023-06-12"))

tgrow_post <- tgrow_post_prep %>%
  merge(temp_data) %>%
  group_by(id, date) %>%
  filter(temp_date >= date - 7 & temp_date < date) %>%
  summarize(tgrow = mean(tmean_c)) %>%
...
write.csv(tgrow_post_prep, "../data/TT23_post_closure_phys_data.csv",
          row.names = FALSE)
...
post.canopy.merged <- snapshot.post %>%
  ...
  dplyr::select(id, spp, plot, subplot, gm.trt, canopy = timepoint, anet, 
                gsw, ci.ca, iwue, l, vcmax, vcmax25, jmax, jmax25, jmax.vcmax) %>%
  filter(!is.na(ci.ca))
...
pre.canopy.merged %>%
  ...
  write.csv("../data/TT23_phys_data.csv", row.names = FALSE)

###############################################################################
## Merge pre-canopy closure and post-canopy closure
###############################################################################
comps <- data.frame(subplot = seq(1,36, 1)) %>%
  mutate(composite = ifelse(subplot == 1 | subplot == 2 | subplot == 7 | subplot == 8, 
                       "C1", 
                       ifelse(subplot == 3 | 
                                subplot == 9,
                              "C2", 
...
phys <- read.csv("../data/TT23_phys_data.csv") %>%
  left_join(comps)
multispeq <- read.csv("../data/raw_data/TT23_multispeq_data.csv") %>%
  dplyr::select(id:canopy, Phi2, FvP_over_FmP, SPAD, -composite)
...
phys.total <- phys %>%
  ...
  mutate(l = ifelse(l < 0, NA, l))

write.csv(phys.total, "../data/TT23_compiled_datasheet.csv",
          row.names = FALSE)
